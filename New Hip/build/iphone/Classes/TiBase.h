...
// in simulator we redefine to format for NewHip Developer console
...
{\
	NSString * exceptionName = [@"org.newhip." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.newhip";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UINewHipNativeItemNone = -1, 
	UINewHipNativeItemSpinner = -2,
	UINewHipNativeItemProgressBar = -3,
	
	UINewHipNativeItemSlider = -4,
	UINewHipNativeItemSwitch = -5,
	UINewHipNativeItemMultiButton = -6,
	UINewHipNativeItemSegmented = -7,
	
	UINewHipNativeItemTextView = -8,
	UINewHipNativeItemTextField = -9,
	UINewHipNativeItemSearchBar = -10,
	
	UINewHipNativeItemPicker = -11,
	UINewHipNativeItemDatePicker = -12,
	
	UINewHipNativeItemInfoLight = -13,
	UINewHipNativeItemInfoDark = -14,
	
	UINewHipNativeItemDisclosure = -15,
	
	UINewHipNativeItemContactAdd = -16
};
